import type { AnySchema, AnySchemaObject, AnyValidateFunction, EvaluatedProperties, EvaluatedItems } from "ajv/dist/types";
import type Ajv from "ajv/dist/core";
import type { InstanceOptions } from "ajv/dist/core";
import { CodeGen, Name, Code, ValueScopeName } from "ajv/dist/compile/codegen";
import { LocalRefs } from "ajv/dist/compile/resolve";
import { JSONType } from "ajv/dist/compile/rules";
